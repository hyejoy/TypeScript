 ...
 * let d: any로 정의하는것과 다르다, Any 타입을 처음부터 정의하면, 어디서든 다 any Type으로 동작
 */
...
/**
 * 💡 타입 넓히기
 *  상수로 선언했을 경우, 리터럴로 추론하지만, let으로 선언한경우에는
 *  개발자가 범용적으로 사용할 수 있도록 number로 추론하는것처럼
 *  타입스크립트가, 범용적으로 사용되는 타입으로 추론해주는 것을
 *  '타입 넓히기 ' 라고한다.
 *
 */
